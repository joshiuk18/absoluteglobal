...
export function IconShoppingBag({ className, ...p }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function IconFacebook({ className, ...p }: IconProps) {
  return (
...
export function IconInstagram({ className, ...p }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden {...p}>
...
export function IconGridDots({ className, ...p }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
